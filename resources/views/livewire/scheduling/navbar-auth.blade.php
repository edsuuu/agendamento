<div>
    ...
    <aside
        class="fixed top-0 left-0 z-40 w-52 h-screen pt-16 bg-blue-black border-r transition-transform sm:translate-x-0 -translate-x-full ">
                ...
                <ul class="space-y-2 p-3">
                    ...
                    <li x-data="{ open: false }">
                        <button @click="open = !open" type="button"
                            ...
                            <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Catálogo</span>
                            ...
                            <li>
                                <a href="#"
                                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Orçamento</span>
                                </a>
                            </li>
                            <li>
                                <a href="#"
                                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Agendados</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li x-data="{ open: false }">
                        <button @click="open = !open" type="button"
                            ...
                            <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Financeiro</span>
                            <svg :class="{ 'rotate-180': open }" class="w-3 h-3 transition-transform"
                                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                      stroke-width="2" d="m1 1 4 4 4-4"/>
                            ...
                            <li>
                                <a href="#"
                                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Meu Plano</span>
                                </a>
                            </li>
                        </ul>
                    </li>
